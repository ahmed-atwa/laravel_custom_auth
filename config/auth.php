...
return [
    ...
    */
    ...
    'guards' => [
        ...
        'tokenGuard' => [
            // "tokenDriver" is what we defined inside Auth::extend at AuthServiceProvider
            'driver' => 'tokenDriver',
            'provider' => 'users',
             ...
             *
             * (1) it will try to get request parameter with that name
             * $this->request->input($this->inputKey)
             *
             * (2) if failed, will try to get cookie with that name
             * \Cookie::get($this->inputKey)
             *
             * (3) if failed, it will try grabbing the token from authorization header
            ...
            */
            'storage_keys'=> ['email', 'username'/* , 'phone' */],
        ],
    ],
